...
public interface StarContract {
    ...
    interface Stops {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.mob.horairesbustb.stop";
        String CONTENT_ITEM_TYPE =
    ...
    interface StopTimes {
        ...
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.mob.horairesbustb.stoptime";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.mob.horairesbustb.stoptime";
    ...
    interface Calendar {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.mob.horairesbustb.calendar";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.mob.horairesbustb.calendar";
    ...
    interface RouteDetails {
        ...
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.mob.horairesbustb.routedetail";
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.mob.horairesbustb.routedetail";
