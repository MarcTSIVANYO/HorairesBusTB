...
class OtherMainActivity : AppCompatActivity() {
    ...
    lateinit var listViewBus: ListView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var myAdapter : ArrayAdapter<String> = ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, stops)
        ...
        listViewBus = findViewById(R.id.listeBusArret)
        ...
        if(savedInstanceState != null){
            ...
            listViewBus.setAdapter(myAdapterBus)
            ...
            btnsearchBus.setOnClickListener(object : View.OnClickListener {
                override fun onClick(view: View?) {
                    ...
                    if (!value.trim().equals("", ignoreCase = true)) {
                        ...
                        Toast.makeText(applicationContext, "Aucun arret trouvé", Toast.LENGTH_SHORT).show()
    ...
    fun getBus(stopName: String): ArrayList<Route>{
        ...
        val selectionArgs: Array<String>? = null
        val sortOrder: String? = null
        val uriBus: Uri = Uri.parse(StarContract.BusRoutes.CONTENT_URI.toString())
